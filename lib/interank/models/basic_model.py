...
class BasicModel(TensorFlowModel):

    """Class for managing the simple model in TensorFlow.

    The simple model only contains a skill parameter for each user
    and a difficulty parameter for each article.
    """
